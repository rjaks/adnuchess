<template>
  <section>
    <h2 class="text-2xl font-semibold mb-6">Extra Modes</h2>
    
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      <!-- PuzzleNida Card -->
      <div class="group block p-6 rounded-2xl border border-white/60 bg-white/50 shadow-sm ring-1 ring-red-100/60">
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-slate-800">PuzzleNida</h3>
            <p class="text-sm text-amber-600 font-semibold">Temporarily unavailable</p>
          </div>
        </div>
        <p class="text-slate-600 text-sm leading-relaxed">We’re refreshing this mode. Check back soon.</p>
        <div class="mt-4 inline-flex items-center gap-2 text-sm font-medium text-gray-500">
      ...
      <NuxtLink 
        to="/quizmania"
        class="group block p-6 bg-white/70 border border-white/60 rounded-2xl shadow-sm hover:shadow-md hover:bg-white/80 transition-all duration-200"
      >
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-slate-800 group-hover:text-[#021d94] transition-colors">QuizMania</h3>
            <p class="text-sm text-slate-600">Chess Knowledge Quiz</p>
          </div>
        </div>
        <p class="text-slate-600 text-sm leading-relaxed">
          Test your chess knowledge with fast-paced quiz battles! Answer questions about openings, tactics, history, and famous games.
        </p>
